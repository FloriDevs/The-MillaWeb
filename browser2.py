...
# Set the default URL and fetch its content on startup
default_url = "https://floridevs.github.io/The-MillaWeb/index.txt"
entry.insert(0, default_url)  # Set the default URL in the entry field
fetch_url()  # Fetch the content of the default URL
